...
//
//        viewPager_main = findViewById<ViewPager>(R.id.viewPager_main) as ViewPager
//        viewpage_top_main = findViewById(R.id.viewpage_top_main)
...
//        val subAirToday = API(context = this).BuscaDeSeries(API.TIPOBUSCA.FILME.melhores)
